...
import static com.rf1m.image2css.exception.Errors.parameterCssClassCollectionIsNull;
...
public abstract class AbstractOutput implements Output{
    protected boolean validate(final List<CssClass> cssClasses) {
        if(null == cssClasses){
            throw new Image2CssValidationException(parameterCssClassCollectionIsNull);
        }else{
            return true;
        }
    }
